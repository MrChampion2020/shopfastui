...
//               }}
//             >
//               <Typography>{!isAuth ? "Login" : (userDet && userDet.name ? userDet.name : "User")}</Typography>
...
//           <Search sx={{ flexGrow: 1, maxWidth: { xs: "100%", sm: "50%", md: "30%" }, mx: { xs: 2, sm: 3 } }}>
//             <SearchIconWrapper>
//               <SearchIcon />
//             </SearchIconWrapper>
  ...
  return (
    ...
    >
      <AppBar
        position="static"
        color="secondary"
        sx={{ backgroundColor: "white", color: "black", boxShadow: "0 1px 0 0 rgba(0, 0, 0, 0.1)" }}
      >
        <Toolbar sx={{ justifyContent: "space-between", alignItems: "center", height: { xs: "64px", md: "80px" }, px: { xs: 2, md: 4 } }}>
          <Box
            component="div"
            onClick={redirectToHome}
            sx={{
          ...
          <Search sx={{ 
            ...
            <SearchIconWrapper>
              <SearchIcon sx={{ fontSize: { xs: "1.25rem", md: "1.5rem" }, color: "grey" }} />
            </SearchIconWrapper>
            <StyledInputBase
              placeholder="Search…"
              onInput={handleSearch}
              ...
              sx={{
                ...
                '& .MuiInputBase-input': {
                  padding: { xs: "8px 8px 8px 0", md: "12px 12px 12px 0" },
                }
              }}
            />
          </Search>

          <Box sx={{ display: "flex", alignItems: "center", width: { xs: "30%", md: "20%" }, justifyContent: "flex-end" }} gap={1}>
            <IconButton
              size="small"
              edge="end"
              aria-label="account of current user"
            ...
            >
              <AccountCircleIcon sx={{ fontSize: { xs: "1.5rem", md: "2rem" }, mr: 0.5 }} />
              <KeyboardArrowDownRoundedIcon sx={{ fontSize: { xs: "1rem", md: "1.25rem" } }} />
            </IconButton>
            ...
            >
              <Badge badgeContent={cartItems.length} color="success">
                <ShoppingCartRoundedIcon sx={{ fontSize: { xs: "1.25rem", md: "1.5rem" } }} />
              </Badge>
            </IconButton>
          </Box>
        </Toolbar>
